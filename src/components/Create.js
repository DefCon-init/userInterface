      ...
      <Jumbotron>
        <Form onSubmit={saveUser}>
          <Form.Group>
            ...
            <Form.Control type="text" name="firstname" id="firstname" placeholder="Enter first name" value={user.firstname} required onChange={onChange} />
          </Form.Group>
          <Form.Group>
            <Form.Label>Last Name</Form.Label>
            <Form.Control type="text" name="lastname" id="lastname" placeholder="Enter last name" value={user.lastname} required onChange={onChange} />
          </Form.Group>
          <Form.Group>
